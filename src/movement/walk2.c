...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/13 19:34:43 by akurz             #+#    #+#             */
/*   Updated: 2021/12/13 19:34:44 by akurz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub.h"

void	ft_move_left_set_posy(t_vars *vars)
{
	double	x;
...
void	ft_walk_left(t_vars *vars)
{
	...
	ft_move_left_set_posy(vars);
}

void	ft_move_forward_set_posy(t_vars *vars)
{
	double	x;
